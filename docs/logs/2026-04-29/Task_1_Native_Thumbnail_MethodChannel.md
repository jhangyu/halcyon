...
### 修改檔案
1. `photo_selector_flutter/macos/Runner/AppDelegate.swift` — 新增 `FlutterMethodChannel` handler
2. （選項）`photo_selector_flutter/macos/Runner/AppDelegate.swift` — 參考 `ios/Runner/AppDelegate.swift`
